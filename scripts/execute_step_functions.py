...
def start_execution(state_machine_arn, execution_name=None, input_data=None):
    """
...
def wait_for_execution_completion(execution_arn, timeout_seconds=3600):
    """
...
def main():
    ...
    state_machine_arn = get_state_machine_arn(STEP_FUNCTIONS_CONFIG['state_machine_name'])
